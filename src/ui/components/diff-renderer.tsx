            ...
            {displayableLines.reduce<React.ReactNode[]>((acc, line, index) => {
                ...
                acc.push(
                    <Box key={lineKey} flexDirection="row">
                        ...
                        <Text color={backgroundColor ? '#000000' : undefined} backgroundColor={backgroundColor}
                              dimColor={!backgroundColor && dim}>{prefixSymbol} </Text>
                        <Text color={backgroundColor ? '#000000' : undefined} backgroundColor={backgroundColor}
                              dimColor={!backgroundColor && dim} wrap="wrap">
                            {displayContent}
                        </Text>
                    </Box>,
                );
